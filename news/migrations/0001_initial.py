# Generated by Django 2.2 on 2021-01-20 11:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, unique=True, verbose_name='Nombre de la categoria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.CharField(choices=[('Colombia', 'Colombia'), ('Internacional', 'Internacional'), ('Política', 'Política'), ('Justicia', 'Justicia'), ('Deporte', 'Deporte'), ('Tendencia', 'Tendencia'), ('Tecnología', 'Tecnología'), ('Entretenimiento', 'Entretenimiento')], default='Colombia', max_length=16, verbose_name='Categoría')),
                ...
                ('is_popular', models.BooleanField(default=False, help_text='¿Seguro que el contenido es popular?', verbose_name='Contenido popular')),
                ('update', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de edición')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('sub_categories', models.ForeignKey(help_text='Es siempre necesario este campo', on_delete=django.db.models.deletion.CASCADE, to='news.Category')),
            ],
            options={
